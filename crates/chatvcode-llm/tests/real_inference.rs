...
//! Run with: cargo test -p chatvcode-llm --test `real_inference` -- --ignored

use chatvcode_llm::{GenerationParams, LlamaService, LlmConfig, LlmService as _};
...
fn test_real_model_inference() {
    ...
    // Cleanup
    chatvcode_llm::shutdown();
}

#[test]
#[ignore] // Run with: cargo test -p chatvcode-llm --test real_inference -- --ignored

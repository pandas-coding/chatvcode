...
use chatvcode_core::{ChunkKind, FileLanguage, IndexResult, index_path};
use chatvcode_parser::parse_source;

// Keep the real-parser fixture integration tests in `chatvcode-parser`.
// This exercises the full chatvcode-core + chatvcode-parser path without introducing
// an chatvcode-core -> chatvcode-parser dev-dependency cycle.
fn fixtures_dir() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../chatvcode-core/tests/fixtures")
}
